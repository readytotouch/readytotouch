...
const vacancyUrlStateContainer = new UrlStateContainer(VACANCY_CRITERIA_NAMES, {
    ...
    [VACANCY_LOCATION_CRITERIA_NAME]: multiSelectCriteriaConverter,
    ...
    [VACANCY_COMPANY_GLASSDOOR_RATING_CRITERIA_NAME]: multiSelectCriteriaConverter,
    [VACANCY_LINKEDIN_COMPANY_SIZE_CRITERIA_NAME]: multiSelectCriteriaConverter,
    [VACANCY_CLOUD_PROVIDER_CRITERIA_NAME]: multiSelectCriteriaConverter,
