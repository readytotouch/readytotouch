...
export const VACANCY_LOCATION_CRITERIA_NAME = unique.unique("location");
...
export const VACANCY_COMPANY_GLASSDOOR_RATING_CRITERIA_NAME = unique.unique("glassdoor-rating");
export const VACANCY_LINKEDIN_COMPANY_SIZE_CRITERIA_NAME = unique.unique("linkedin-company-size");
export const VACANCY_CLOUD_PROVIDER_CRITERIA_NAME = unique.unique("cloud-provider");
