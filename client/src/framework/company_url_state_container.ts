...
const companyUrlStateContainer = new UrlStateContainer(COMPANY_CRITERIA_NAMES, {
    ...
    [COMPANY_GLASSDOOR_RATING_CRITERIA_NAME]: multiSelectCriteriaConverter,
    [COMPANY_LINKEDIN_COMPANY_SIZE_CRITERIA_NAME]: multiSelectCriteriaConverter,
    [COMPANY_CLOUD_PROVIDER_CRITERIA_NAME]: multiSelectCriteriaConverter,
