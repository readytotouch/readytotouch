...
# make more-companies-linkedin VERSION=101
more-companies-linkedin:
ifndef VERSION
	$(error VERSION is not set. Use `make more-companies-linkedin VERSION=X`)
endif
	git checkout main && git pull
	git checkout -b more-companies-linkedin-november-2025-v$(VERSION)
	git commit -m "More companies LinkedIn November 2025 v$(VERSION)" --allow-empty

# make more-companies-welcome-to-the-jungle VERSION=101
more-companies-welcome-to-the-jungle:
ifndef VERSION
	$(error VERSION is not set. Use `make more-companies-welcome-to-the-jungle VERSION=X`)
endif
	git checkout main && git pull
	git checkout -b more-companies-welcome-to-the-jungle-november-2025-v$(VERSION)
	git commit -m "More companies Welcome to the Jungle November 2025 v$(VERSION)" --allow-empty

# make more-companies-indeed VERSION=101
more-companies-indeed:
ifndef VERSION
	$(error VERSION is not set. Use `make more-companies-indeed VERSION=X`)
endif
	git checkout main && git pull
	git checkout -b more-companies-indeed-november-2025-v$(VERSION)
	git commit -m "More companies Indeed November 2025 v$(VERSION)" --allow-empty
