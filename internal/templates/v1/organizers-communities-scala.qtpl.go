...
<section class="organizer-communities">
	<div class="container organizer-communities__container-block">
		<div class="hero">
			<div class="hero__fill hero__fill--scala"></div>
			<div class="organizer-communities__headline headline">Scala Developers Communities</div>
		</div>
	</div>
</section>
<section class="organizer-communities">
				...
				<figure class="card__header">
					<div class="card__image-overlay card__image-overlay--small">
						<img
							...
							src="/assets/images/pages/organizer/scala-communities-2.png"
						/>
					</div>
