...
func StreamOrganizersCommunitiesRust(qw422016 *qt422016.Writer, organizer Organizer, headerProfiles []SocialProviderUser) {
...
<section class="organizer-communities">
	<div class="container organizer-communities__container-block">
		<div class="hero">
			<div class="hero__fill hero__fill--rust"></div>
			<div class="organizer-communities__headline headline">Rust Developers Communities</div>
		</div>
	</div>
</section>
<section class="organizer-communities">
	<div class="container organizer-communities__container">
		<p class="organizer-communities__count"><strong>3</strong> Communities</p>
		<div class="organizer-communities__list">
				...
				<figure class="card__header">
					<div class="card__image-overlay card__image-overlay--small">
						<img
							...
							src="/assets/images/pages/organizer/rust-communities-1.png"
						/>
					</div>
					<figcaption class="card__header-caption">
						<a href="https://www.rust-lang.org/community" target="_blank" class="card__headline vacancy__link">Rustlang Community</a>
					</figcaption>
					<a href="https://www.rust-lang.org/community" target="_blank" class="button button--small-padding button--black button--gap-images">
						Visit
			...
			<div class="card">
				<figure class="card__header">
					...
					<figcaption class="card__header-caption">
						<a href="https://www.reddit.com/r/rust/" target="_blank" class="card__headline vacancy__link">r/rust</a>
					</figcaption>
					<a href="https://www.reddit.com/r/rust/" target="_blank" class="button button--small-padding button--black button--gap-images">
						Visit
						<img width="18" height="18" alt="arrow top icon" src="/assets/images/pages/common/external-link-white.svg">
					</a>
				</figure>
				...
				<figure class="card__header">
					<div class="card__image-overlay card__image-overlay--small">
						<img
							...
							class="card__image card__image--preview"
							alt="card image preview icon"
							src="/assets/images/pages/organizer/rust-communities-2.png"
						/>
					</div>
					<figcaption class="card__header-caption">
						<a href="https://github.com/rust-lang-ua" target="_blank" class="card__headline vacancy__link">Ukrainian Rust Community</a>
					</figcaption>
					<a href="https://github.com/rust-lang-ua" target="_blank" class="button button--small-padding button--black button--gap-images">
						Visit
						<img width="18" height="18" alt="arrow top icon" src="/assets/images/pages/common/external-link-white.svg">
					</a>
				</figure>
				<p class="card__sub-headline">
					We 🦀 are a Ukrainian branch of the Rust enthusiasts community 💙💛
				</p>
			</div>
...
func WriteOrganizersCommunitiesRust(qq422016 qtio422016.Writer, organizer Organizer, headerProfiles []SocialProviderUser) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	StreamOrganizersCommunitiesRust(qw422016, organizer, headerProfiles)
	qt422016.ReleaseWriter(qw422016)
}

func OrganizersCommunitiesRust(organizer Organizer, headerProfiles []SocialProviderUser) string {
	qb422016 := qt422016.AcquireByteBuffer()
	WriteOrganizersCommunitiesRust(qb422016, organizer, headerProfiles)
