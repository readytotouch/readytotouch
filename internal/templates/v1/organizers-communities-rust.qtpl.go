		...
		<div class="organizer-communities__list">
			<div class="card">
				<figure class="card__header">
					...
					<figcaption class="card__header-caption">
						<a href="https://www.rust-lang.org/community" class="card__headline vacancy__link">Rustlang Community</a>
					</figcaption>
					<a href="https://www.rust-lang.org/community" class="button button--small-padding button--black button--gap-images">
						Visit
			...
			<div class="card">
				<figure class="card__header">
					...
					<figcaption class="card__header-caption">
						<a href="https://www.reddit.com/r/rust/" class="card__headline vacancy__link">r/rust</a>
					</figcaption>
					<a href="https://www.reddit.com/r/rust/" class="button button--small-padding button--black button--gap-images">
						Visit
						<img width="18" height="18" alt="arrow top icon" src="/assets/images/pages/common/external-link-white.svg">
					</a>
				</figure>
			...
			<div class="card">
				<figure class="card__header">
					...
					<figcaption class="card__header-caption">
						<a href="https://github.com/rust-lang-ua" class="card__headline vacancy__link">Ukrainian Rust Community</a>
					</figcaption>
					<a href="https://github.com/rust-lang-ua" class="button button--small-padding button--black button--gap-images">
						Visit
						<img width="18" height="18" alt="arrow top icon" src="/assets/images/pages/common/external-link-white.svg">
					</a>
				</figure>
