// Code generated by qtc from "private-unstable-wip-data-population-companies-indeed.qtpl". DO NOT EDIT.
...
func StreamDataPopulationCompaniesIndeed(qw422016 *qt422016.Writer, companies []Company, title string) {
...
<ul>
    ...
    <li>
		...
		if company.IndeedProfile.Alias == "" {
			qw422016.N().S(`
            <a href='`)
			qw422016.E().S(googleSearchIndeed(hostname(company.BaseURL)))
...
func WriteDataPopulationCompaniesIndeed(qq422016 qtio422016.Writer, companies []Company, title string) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	StreamDataPopulationCompaniesIndeed(qw422016, companies, title)
	qt422016.ReleaseWriter(qw422016)
}

func DataPopulationCompaniesIndeed(companies []Company, title string) string {
	qb422016 := qt422016.AcquireByteBuffer()
	WriteDataPopulationCompaniesIndeed(qb422016, companies, title)
