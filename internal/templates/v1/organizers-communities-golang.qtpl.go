// Code generated by qtc from "organizers-communities-golang.qtpl". DO NOT EDIT.
...
func StreamOrganizersCommunitiesGolang(qw422016 *qt422016.Writer, organizer Organizer, headerProfiles []SocialProviderUser) {
...
<section class="organizer-communities">
	<div class="container organizer-communities__container-block">
		<div class="hero">
			<div class="hero__fill hero__fill--go"></div>
			<div class="organizer-communities__headline headline">Golang Developers Communities</div>
		</div>
	</div>
</section>
<section class="organizer-communities">
		...
		<div class="organizer-communities__list">
			<div class="card">
				<figure class="card__header">
					<div class="card__image-overlay card__image-overlay--small">
						<img
							...
							src="/assets/images/pages/organizer/go-image.png"
						/>
					</div>
					<figcaption class="card__header-caption">
						<a href="https://discord.com/invite/golang" target="_blank" class="card__headline vacancy__link">Discord Gophers</a>
					</figcaption>
					<a href="https://discord.com/invite/golang" target="_blank" class="button button--small-padding button--black button--gap-images">
						Visit
				...
				<p class="card__sub-headline">
					Community to discuss, learn, and provide help for the Go language.
				</p>
			</div>
				...
				<figure class="card__header">
					<div class="card__image-overlay card__image-overlay--small">
						<img
							...
							class="card__image card__image--preview"
							alt="card image preview icon"
							src="/assets/images/pages/organizer/go-small.png"
						/>
					</div>
					<figcaption class="card__header-caption">
						<a href="https://www.reddit.com/r/golang/" target="_blank" class="card__headline vacancy__link">r/golang</a>
					</figcaption>
					<a href="https://www.reddit.com/r/golang/" target="_blank" class="button button--small-padding button--black button--gap-images">
						Visit
						<img width="18" height="18" alt="arrow top icon" src="/assets/images/pages/common/external-link-white.svg">
					</a>
				</figure>
...
func WriteOrganizersCommunitiesGolang(qq422016 qtio422016.Writer, organizer Organizer, headerProfiles []SocialProviderUser) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	StreamOrganizersCommunitiesGolang(qw422016, organizer, headerProfiles)
	qt422016.ReleaseWriter(qw422016)
}

func OrganizersCommunitiesGolang(organizer Organizer, headerProfiles []SocialProviderUser) string {
	qb422016 := qt422016.AcquireByteBuffer()
	WriteOrganizersCommunitiesGolang(qb422016, organizer, headerProfiles)
