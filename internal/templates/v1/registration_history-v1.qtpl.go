// Code generated by qtc from "registration_history-v1.qtpl". DO NOT EDIT.
...
func streamregistrationHistoryV1(qw422016 *qt422016.Writer, socialProviderUsers []SocialProviderUser) {
	qw422016.N().S(`
`)
...
func writeregistrationHistoryV1(qq422016 qtio422016.Writer, socialProviderUsers []SocialProviderUser) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	streamregistrationHistoryV1(qw422016, socialProviderUsers)
	qt422016.ReleaseWriter(qw422016)
}

func registrationHistoryV1(socialProviderUsers []SocialProviderUser) string {
	qb422016 := qt422016.AcquireByteBuffer()
	writeregistrationHistoryV1(qb422016, socialProviderUsers)
