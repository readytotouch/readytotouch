// Code generated by qtc from "private-unstable-wip-data-population-companies-glassdoor.qtpl". DO NOT EDIT.
...
func StreamDataPopulationCompaniesGlassdoor(qw422016 *qt422016.Writer, companies []Company, title string) {
...
func WriteDataPopulationCompaniesGlassdoor(qq422016 qtio422016.Writer, companies []Company, title string) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	StreamDataPopulationCompaniesGlassdoor(qw422016, companies, title)
	qt422016.ReleaseWriter(qw422016)
}

func DataPopulationCompaniesGlassdoor(companies []Company, title string) string {
	qb422016 := qt422016.AcquireByteBuffer()
	WriteDataPopulationCompaniesGlassdoor(qb422016, companies, title)
