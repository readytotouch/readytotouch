...
<div class="header__profile">
  <div class="header__profile-avatar js-header-profile-avatar">
    <button class="header__profile-button js-header-profile-button">
      <img src="`)
	qw422016.E().S(SocialProviderUserHeaderPhoto(profiles))
	qw422016.N().S(`" alt="photo-profile" />
    </button>
    <p class="header__profile-avatar-text">`)
	qw422016.E().S(SocialProviderUserName(profiles[0]))
	qw422016.N().S(`</p>
    <button class="header__profile-arrow-button">
      <img class="header__profile-avatar-arrow-img"
           width="12"
           height="12"
           src="/assets/images/pages/common/chevron_right.svg"
           alt="arrow right icon"
      />
    </button>
  </div>
  <div class="header__profile-list-mobile profile-list-mobile">
    `)
    ...
    >
      <img class="profile-list-mobile__profile-image"
           ...
           alt="GitHub logo"
      />
      <span class="profile-list-mobile__profile-text">github.com/`)
			qw422016.E().S(profile.Username)
			qw422016.N().S(`</span>
    </a>
    `)
    ...
    >
      <img class="profile-list-mobile__profile-image"
           ...
           alt="GitLab logo"
      />
      <span class="profile-list-mobile__profile-text">gitlab.com/`)
			qw422016.E().S(profile.Username)
			qw422016.N().S(`</span>
    </a>
    `)
  ...
  <div class="header__modal modal-profile js-modal-profile">
