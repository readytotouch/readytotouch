// Code generated by qtc from "organizers-footer-v3.qtpl". DO NOT EDIT.
...
func streamorganizersFooterV3(qw422016 *qt422016.Writer, stars int32) {
	qw422016.N().S(`
<footer class="footer">
  <div class="footer__overlay">
	...
	qw422016.N().S(`</a>
          ...
          <div class="footer__support">
            ...
            <a href="https://war.ukraine.ua/" target="_blank" class="button button--bordered-gray footer__link footer__link--ukraine">
              war.ukraine.ua
              <div class="footer__support-icon-box">
                <img width="18"
                     height="18"
...
func writeorganizersFooterV3(qq422016 qtio422016.Writer, stars int32) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	streamorganizersFooterV3(qw422016, stars)
	qt422016.ReleaseWriter(qw422016)
}

func organizersFooterV3(stars int32) string {
	qb422016 := qt422016.AcquireByteBuffer()
	writeorganizersFooterV3(qb422016, stars)
