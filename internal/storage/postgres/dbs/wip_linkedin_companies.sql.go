...
type WipLinkedInCompanyRequestHistoryCountParams struct {
	CreatedBy      int64
	AfterCreatedAt time.Time
}

func (q *Queries) WipLinkedInCompanyRequestHistoryCount(ctx context.Context, arg WipLinkedInCompanyRequestHistoryCountParams) (int64, error) {
	row := q.queryRow(ctx, q.wipLinkedInCompanyRequestHistoryCountStmt, wipLinkedInCompanyRequestHistoryCount, arg.CreatedBy, arg.AfterCreatedAt)
	var total int64
	err := row.Scan(&total)
	return total, err
}
