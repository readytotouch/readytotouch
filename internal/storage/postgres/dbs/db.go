...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.githubRepositoryStarsStmt, err = db.PrepareContext(ctx, githubRepositoryStars); err != nil {
		return nil, fmt.Errorf("error preparing query GithubRepositoryStars: %w", err)
	}
	if q.githubRepositoryStarsAllStmt, err = db.PrepareContext(ctx, githubRepositoryStarsAll); err != nil {
		return nil, fmt.Errorf("error preparing query GithubRepositoryStarsAll: %w", err)
	}
	if q.githubRepositoryStarsUpsertStmt, err = db.PrepareContext(ctx, githubRepositoryStarsUpsert); err != nil {
		return nil, fmt.Errorf("error preparing query GithubRepositoryStarsUpsert: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.githubRepositoryStarsStmt != nil {
		if cerr := q.githubRepositoryStarsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing githubRepositoryStarsStmt: %w", cerr)
		}
	}
	if q.githubRepositoryStarsAllStmt != nil {
		if cerr := q.githubRepositoryStarsAllStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing githubRepositoryStarsAllStmt: %w", cerr)
		}
	}
	if q.githubRepositoryStarsUpsertStmt != nil {
		if cerr := q.githubRepositoryStarsUpsertStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing githubRepositoryStarsUpsertStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	githubRepositoryStarsStmt                            *sql.Stmt
	githubRepositoryStarsAllStmt                         *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		githubRepositoryStarsStmt:                            q.githubRepositoryStarsStmt,
		githubRepositoryStarsAllStmt:                         q.githubRepositoryStarsAllStmt,
