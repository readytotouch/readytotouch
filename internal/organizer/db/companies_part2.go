					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2025-02-09"), // mustDate("2025-01-16"), // mustDate("2024-10-29"), // mustDate("2024-12-31"),
							WithSalary:           false,
							Remote:               false,
						},
					},
			...
			Languages: domain.Languages{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Software Engineer Specialist (Scala)",
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:             mustDate("2025-02-10"), // mustDate("2025-01-21"), // mustDate("2025-01-13"), // mustDate("2024-11-04"),
						},
					},
				},
				domain.Elixir:  {},
