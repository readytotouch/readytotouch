	...
	return []domain.CompanyProfile{
		{
			...
			Type:       "", // system
			Name:       "Vidsy",
			BaseURL:    "https://www.vidsy.co/",
			CareersURL: "https://jobs.lever.co/vidsy",
			AboutURL:   "https://www.vidsy.co/about",
			BlogURL:    "",
...

		{
			...
			Type:       "", // system
			Name:       "RBC",
			BaseURL:    "https://www.rbc.com/",
			CareersURL: "https://jobs.rbc.com/",
			AboutURL:   "https://www.rbc.com/about-rbc.html",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1808,
				Alias:             "rbc",
			...
			Languages: domain.Languages{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						{
							Title:                "Software Development Engineer (Java/Scala)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377024331/",
							Location:             "Toronto, ON",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-16", "2026-03-17", "2026-02-24"),
							WithSalary:           false,
							Remote:               false,
						},
					},
...

		{
			...
			Type:       "", // system
			Name:       "Stake",
			BaseURL:    "https://hellostake.com/",
			CareersURL: "https://hellostake.com/careers",
			AboutURL:   "https://hellostake.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                17955503,
				Alias:             "hello-stake",
...

		{
			...
			Type:       "", // system
			Name:       "DriveNets",
			BaseURL:    "https://drivenets.com/",
			CareersURL: "https://drivenets.com/careers/",
			AboutURL:   "https://drivenets.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                11282464,
				Alias:             "drivenets",
...

		{
			...
			Type:       "", // system
			Name:       "IFS",
			BaseURL:    "https://www.ifs.com/",
			CareersURL: "https://www.ifs.com/about/careers-at-ifs",
			AboutURL:   "https://www.ifs.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                164301,
				Alias:             "ifs",
...

		{
			...
			BaseURL:    "https://www.lightspeedsystems.com/",
			CareersURL: "https://www.lightspeedsystems.com/about/careers/",
			AboutURL:   "https://www.lightspeedsystems.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                887484,
...

		{
			...
			Type:       "", // system
			Name:       "KNIME",
			BaseURL:    "https://www.knime.com/",
			CareersURL: "https://www.knime.com/careers",
			AboutURL:   "https://www.knime.com/about",
			BlogURL:    "https://www.knime.com/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                692207,
				Alias:             "knime",
				Name:              "KNIME",
...

		{
			...
			CareersURL: "https://www.twitch.tv/jobs/",
			AboutURL:   "https://www.twitch.tv/about/",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Golang, TypeScript/React",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4325252246/",
							Location:             "San Francisco, CA",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-25"),
							WithSalary:           true, // $99.5k/yr - $200k/yr
							Remote:               false,
						},
					},
				},
...

		{
			...
			Type:       "", // system
			Name:       "Assembled",
			BaseURL:    "https://www.assembled.com/",
			CareersURL: "https://www.assembled.com/careers-at-assembled",
			AboutURL:   "https://www.assembled.com/about",
			BlogURL:    "https://www.assembled.com/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                26571599,
				Alias:             "assembledhq",
				Name:              "Assembled",
...

		{
			...
			Type:       "", // system
			Name:       "Rundoo",
			BaseURL:    "https://getrundoo.com/",
			CareersURL: "https://jobs.ashbyhq.com/rundoo",
			AboutURL:   "https://www.getrundoo.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                71237489,
				Alias:             "rundoo",
...

		{
			...
			Type:       "", // system
			Name:       "Zelis",
			BaseURL:    "https://www.zelis.com/",
			CareersURL: "https://www.zelis.com/company/careers/",
			AboutURL:   "https://www.zelis.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                10797668,
...

		{
			...
			CareersURL: "https://www.careers.ford.com/",
			AboutURL:   "https://corporate.ford.com/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1483,
...

		{
			...
			Type:       "", // system
			Name:       "GitGuardian",
			BaseURL:    "https://www.gitguardian.com/",
			CareersURL: "https://www.gitguardian.com/careers",
			AboutURL:   "https://www.gitguardian.com/about-us",
			BlogURL:    "https://blog.gitguardian.com/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                27139915,
				Alias:             "gitguardian",
				Name:              "GitGuardian",
		...
		// BigTech
		{
			...
			AboutURL:   "https://www.dell.com/en-us/lp/dt/who-we-are",
			BlogURL:    "https://www.dell.com/community/en/topics/developer-blogs",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                15088102,
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Software Engineer (C, C++ or Golang)",
							ShortDescription:     "Kubernetes, Storage, Systems Programming",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4372997367/",
...

		{
			...
			Type:       "", // system
			Name:       "DailyPay",
			BaseURL:    "https://www.dailypay.com/",
			CareersURL: "https://www.dailypay.com/careers/",
			AboutURL:   "https://www.dailypay.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                6654085,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4397260823/",
							Location:             "Belfast, Northern Ireland, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
...

		{
			...
			Type:       "", // system
			Name:       "Shopware",
			BaseURL:    "https://www.shopware.com/",
			CareersURL: "https://www.shopware.com/en/jobs/",
			AboutURL:   "https://www.shopware.com/en/company/",
			BlogURL:    "https://www.shopware.com/en/news/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5300057,
				IDs:               nil,
				Alias:             "shopware-ag",
...

		{
			...
			Type:       "", // system
			Name:       "StarHub",
			BaseURL:    "https://www.starhub.com/",
			CareersURL: "https://careers.starhub.com/",
			AboutURL:   "https://corporate.starhub.com/about-us.html",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                166131,
				IDs:               nil,
		...
		// BigTech
		{
			...
			Type:       "", // system
			Name:       "Rakuten",
			BaseURL:    "https://global.rakuten.com/",
			CareersURL: "https://global.rakuten.com/corp/careers/",
			AboutURL:   "https://global.rakuten.com/corp/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                47584,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Tokyo, Japan",
							Date:                 mustDate("2025-12-13", "2025-10-08"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4368445148/",
							Location:             "Tokyo, Japan",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			Type:       "", // system
			Name:       "Vital Bio",
			BaseURL:    "https://vitalbio.com/",
			CareersURL: "https://vitalbio.com/careers",
			AboutURL:   "https://vitalbio.com/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                19033427,
				IDs:               nil,
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344752795/",
							Location:             "Atlanta, GA",
						...
						{
							Title:                "Senior Software Engineer",
							ShortDescription:     "Write high-quality, maintainable code in Elixir/Phoenix",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377254836/",
							Location:             "United States",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			BaseURL:    "https://www.thoughtmachine.net/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
...

		{
			...
			Type:       "", // system
			Name:       "Kantar",
			BaseURL:    "https://www.kantar.com/",
			CareersURL: "https://www.kantar.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                83111,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Krakowski, Małopolskie, Poland",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-14", "2026-03-24", "2026-03-02", "2026-02-10", "2026-01-20"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4366197840/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4375007774/",
							Location:             "Ukraine",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4381917193/",
							Location:             "Spain",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4402577567/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Scorebuddy",
			BaseURL:    "https://www.scorebuddyqa.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Fullstack Engineer – Go/JavaScript/TypeScript",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4400915261/",
		...
		},
		{
			...
			BaseURL:    "https://www.dgepress.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.collinsaerospace.com/",
			CareersURL: "https://www.collinsaerospace.com/careers/engineering",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                11695727,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Prima",
			BaseURL:    "https://www.helloprima.com/",
			CareersURL: "https://www.helloprima.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9305779,
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2026-04-20", "2026-03-17", "2026-02-25", "2026-02-03", "2025-12-24", "2025-12-02", "2025-11-10", "2025-09-06", "2025-06-13", "2025-05-22", "2025-05-01", "2025-04-09"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							Date:                 mustDate("2026-03-31", "2026-03-22", "2026-02-27", "2026-02-07", "2026-01-16", "2025-12-25", "2025-12-04", "2025-11-12", "2025-10-22", "2025-09-30", "2025-09-08", "2025-08-17", "2025-07-26", "2025-07-04", "2025-06-14"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							Date:                 mustDate("2026-01-13", "2025-12-21", "2025-11-29", "2025-09-27", "2025-09-06"),
							WithSalary:           false,
							Remote:               true,
						},
					},
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Madrid, Community of Madrid, Spain",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-18", "2026-02-24", "2026-02-03", "2026-01-13", "2025-12-21", "2025-05-22", "2025-04-29"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							Location:             "London, England, United Kingdom",
							Date:                 mustDate("2026-03-31", "2025-11-29", "2025-11-09", "2025-10-19", "2025-09-27", "2025-09-06", "2025-08-15", "2025-07-24", "2025-07-03", "2025-06-13"),
							WithSalary:           false,
							Remote:               true,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Wasmer",
			BaseURL:    "https://wasmer.io/",
			CareersURL: "",
			AboutURL:   "https://wasmer.io/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                18946055,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4384577862/",
		...
		},
		{
			...
			CareersURL: "https://www.takealot.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1167110,
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344017731/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377835453/",
							Location:             "Cape Town, Western Cape, South Africa",
							CloudProviders:       []domain.CloudProvider{domain.GCP},
							Date:                 mustDate("2026-02-25"),
							WithSalary:           false,
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4385508294/",
							Location:             "Cape Town, Western Cape, South Africa",
							CloudProviders:       []domain.CloudProvider{domain.GCP},
							Date:                 mustDate("2026-03-13"),
							WithSalary:           false,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Maropost",
			BaseURL:    "https://www.maropost.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Corsearch",
			BaseURL:    "https://corsearch.com/",
			CareersURL: "https://careers.corsearch.com/jobs",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2593860,
				...
				domain.Clojure: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "United States",
							Date:                 mustDate("2025-12-24", "2025-12-17", "2025-12-11"),
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4329994517/",
							Location:             "United States",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Cars Commerce",
			BaseURL:    "https://www.carscommerce.inc/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Loblaw Digital",
			BaseURL:    "https://loblawdigital.co/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Claritev",
			BaseURL:    "https://www.claritev.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "LSEG",
			BaseURL:    "https://www.lseg.com/",
			CareersURL: "https://www.lseg.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1314683,
			...
			Languages: domain.Languages{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Lead Scala Engineer",
							ShortDescription:     "Post Trade",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4363947016/",
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-18", "2026-03-07", "2026-02-13"),
							WithSalary:           true, // $129.7k/yr - $216.1k/yr
							Remote:               false,
						},
						{
							Title:                "Senior Lead Scala Engineer",
							ShortDescription:     "Post Trade",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4371311646/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Getnet",
			BaseURL:    "https://www.getnetworld.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SawitPRO",
			BaseURL:    "https://www.sawitpro.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "blp",
			BaseURL:    "https://blp.digital/",
			CareersURL: "https://blp.digital/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                26561819,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Wonderschool",
			BaseURL:    "https://www.wonderschool.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Eightcap",
			BaseURL:    "https://www.eightcap.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Founding Engineer (Go)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4369054410/",
							Location:             "Amsterdam, North Holland, Netherlands",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Name:       "AccessOwl",
			BaseURL:    "https://www.accessowl.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Software Engineer (Elixir Focus)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4391866242/",
							Location:             "Georgia",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Proficiency in Elixir, NodeJS and ReactJS is required",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4368503354/",
							Location:             "Toronto, ON",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-26"),
							WithSalary:           false,
						...
						{
							Title:                "Senior Software Development Engineer (Java, Scala)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4379418539/",
							Location:             "Bucharest, Bucharest, Romania",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-16", "2026-03-25", "2026-03-04"),
							WithSalary:           false,
							Remote:               false,
						},
					},
