...
func companies15Shard() []domain.CompanyProfile {
	return []domain.CompanyProfile{
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2026-05-08", "2026-04-16", "2026-03-17", "2026-02-24"),
							WithSalary:           false,
							Remote:               false,
						},
					},
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Systems Engineer – Golang",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4404064055/",
							Location:             "Colombo, Western Province, Sri Lanka",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1483,
				IDs:               []int{1483, 1484, 10033554, 13328925, 20133452, 65279540},
				Alias:             "ford-motor-company",
				Name:              "Ford Motor Company",
				Followers:         "4M",
				Employees:         "10K+",
				AssociatedMembers: "174,845",
				Verified:          true,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4408088229/",
							Location:             "Palo Alto, CA",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4411255922/",
							Location:             "Oakville, ON",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4417378942/",
							Location:             "Oakville, ON",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-20", "2026-05-21"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Krakowski, Małopolskie, Poland",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-20", "2026-05-06", "2026-04-14", "2026-03-24", "2026-03-02", "2026-02-10", "2026-01-20"),
							WithSalary:           false,
							Remote:               false,
						},
					},
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2026-06-25", "2026-05-13", "2026-04-20", "2026-03-17", "2026-02-25", "2026-02-03", "2025-12-24", "2025-12-02", "2025-11-10", "2025-09-06", "2025-06-13", "2025-05-22", "2025-05-01", "2025-04-09"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							Date:                 mustDate("2026-06-23", "2026-05-11", "2026-03-31", "2026-03-22", "2026-02-27", "2026-02-07", "2026-01-16", "2025-12-25", "2025-12-04", "2025-11-12", "2025-10-22", "2025-09-30", "2025-09-08", "2025-08-17", "2025-07-26", "2025-07-04", "2025-06-14"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							Date:                 mustDate("2026-06-24", "2026-05-11", "2026-01-13", "2025-12-21", "2025-11-29", "2025-09-27", "2025-09-06"),
							WithSalary:           false,
							Remote:               true,
						},
					},
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Location:             "Milan, Lombardy, Italy",
							Date:                 mustDate("2026-05-11", "2026-04-20", "2025-07-23", "2025-07-02", "2025-04-08"),
							WithSalary:           false,
							Remote:               true,
						},
						{
						...
						},
						{
							...
							Location:             "London, England, United Kingdom",
							Date:                 mustDate("2026-06-24", "2026-03-31", "2025-11-29", "2025-11-09", "2025-10-19", "2025-09-27", "2025-09-06", "2025-08-15", "2025-07-24", "2025-07-03", "2025-06-13"),
							WithSalary:           false,
							Remote:               true,
						},
					},
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-10", "2026-04-18", "2026-03-07", "2026-02-13"),
						...
						},
						{
							...
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-22", "2026-03-28"),
							WithSalary:           false,
							Remote:               false,
						},
					},
					...
					Vacancies: []domain.Vacancy{
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-26", "2026-05-15", "2026-04-23", "2026-03-31", "2026-03-10"),
							WithSalary:           false,
							Remote:               false,
						},
						{
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Bucharest, Bucharest, Romania",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-08", "2026-04-16", "2026-03-25", "2026-03-04"),
							WithSalary:           false,
							Remote:               false,
						},
					},
