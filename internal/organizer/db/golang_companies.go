...
func GolangCompanies() []domain.Company {
	return []domain.Company{
		...
		},
		{
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://www.linkedin.com/jobs/view/3818119706/", "https://app.otta.com/jobs/0bz2Xy75"},
		},
		{
			Name: "OpenWeb",
		...
		},
		{
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://www.linkedin.com/jobs/view/4011177772/"},
		},
		{
			Name: "Netlify",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/qdIzdfOu"},
		},
		{
			Name: "Unlimit",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/P4ept_aQ"},
		},
		{
			Name: "SoundCloud",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/Q8WY5QwP"},
		},
		{
			Name: "Chime",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/nKhnfPzD"},
		},
		{
		...
		},
		{
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/xpGrXDnd"},
		},
		{
			Name: "CrowdStrike",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/Ex_2fkZL"},
		},
		{
			Name: "Compass",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/EK9Av13p"},
		},
		{
			Name: "Exasol",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/yfqng_As"},
		},
		{
			Name: "SentinelOne",
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/RN0fzEWC"},
		},
		{
			...
			YouTubeChannelURL: "",
			MainLanguage:      false,
			Vacancies:         []string{"https://app.otta.com/jobs/L8SSyDNH"},
		},
		//{
		//	Name: "",
		//	URL:  "",
