...
func companies18Shard() []domain.CompanyProfile {
	return []domain.CompanyProfile{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4375437346/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-04", "2026-03-13", "2026-02-20"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Florida Blue",
			BaseURL:    "http://www.floridablue.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "GreyOrange",
			BaseURL:    "https://www.greyorange.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "HealthEquity",
			BaseURL:    "https://www.healthequity.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "foodpanda",
			BaseURL:    "https://www.foodpanda.com/",
			CareersURL: "https://careers.foodpanda.com/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2569398,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Singapore, Singapore",
							Date:                 mustDate("2025-12-19", "2025-11-26"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4397275608/",
							Location:             "Singapore, Singapore",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4399651016/",
							Location:             "Singapore, Singapore",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-23", "2026-04-14"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Opendoor",
			BaseURL:    "https://www.opendoor.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SuperAnnotate",
			BaseURL:    "https://www.superannotate.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Monumental",
			BaseURL:    "https://www.monumental.co/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Full Stack Engineer – PHP/Go + Flutter",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4392930801/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4399732084/",
		...
		},
		{
			...
			CareersURL: "https://insiderone.com/about-us/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2560882,
				...
				Alias:             "insiderone",
				PreviousAliases:   []string{"useinsider"},
				Name:              "Insider One",
				Followers:         "148K",
				Employees:         "1K-5K",
				AssociatedMembers: "1,537",
				Verified:          true,
				Date:              mustDate("2026-05-22"),
			},
			GitHubProfile: domain.GitHubProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4417769602/",
							Location:             "Istanbul, Istanbul, Türkiye",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Uniphore",
			BaseURL:    "https://www.uniphore.com/",
			CareersURL: "https://www.uniphore.com/careers/",
			AboutURL:   "https://www.uniphore.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1331150,
				IDs:               nil,
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Staff Software Engineer (Java/Go with AI)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4328768284/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
						...
						{
							Title:                "Principal Software Engineer (Java/Go with AI)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4360751463/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
						...
						{
							Title:                "Software Engineer (Java/Go with AI)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4382193722/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394278521/",
							Location:             "Austin, TX",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-05"),
							WithSalary:           true, // $90k/yr - $180k/yr
							Remote:               true,
						},
						{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4358279992/",
							Location:             "Reston, VA",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Travelport",
			BaseURL:    "https://www.travelport.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Marketer.com",
			BaseURL:    "https://www.marketer.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "WPP Media",
			BaseURL:    "https://www.wppmedia.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			LinkedInProfile: domain.LinkedInProfile{
				...
				IDs:               nil,
				Alias:             "lonelyplanet",
				PreviousAliases:   []string{"lonely-planet"},
				Name:              "Lonely Planet",
				Followers:         "125K",
				Employees:         "51-200",
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Warsaw, Mazowieckie, Poland",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-02", "2026-02-25", "2026-02-03", "2026-01-16"),
							WithSalary:           false,
							Remote:               false,
						},
						{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Fortanix",
			BaseURL:    "https://www.fortanix.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.take2games.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Further",
			BaseURL:    "https://www.gofurther.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377136894/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4380786015/",
							Location:             "Barcelona, Catalonia, Spain",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4388392785/",
							Location:             "Barcelona, Catalonia, Spain",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394667893/",
							Location:             "Barcelona, Catalonia, Spain",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-01"),
							WithSalary:           false,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "LivePerson",
			BaseURL:    "https://www.liveperson.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4366543885/",
							Location:             "Ljubljana, Ljubljana, Slovenia",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "audibene",
			BaseURL:    "https://www.audibene.de/",
			CareersURL: "https://karriere.audibene.de/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3248758,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4372627207/",
							Location:             "Berlin, Berlin, Germany",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SOAX",
			BaseURL:    "https://soax.com/",
			CareersURL: "https://soax.com/careers",
			AboutURL:   "https://soax.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                34924582,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Proxy",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4361133590/",
							Location:             "Georgia",
		...
		},
		{
			...
			BaseURL:    "https://www.quorumsoftware.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "State Street",
			BaseURL:    "https://www.statestreet.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387335034/",
							Location:             "North Sydney, New South Wales, Australia",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-20"),
							WithSalary:           false,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Castor",
			BaseURL:    "https://www.castoredc.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Symbolica AI",
			BaseURL:    "https://www.symbolica.ai/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-05-15", "2026-04-23", "2026-01-29", "2026-01-08", "2025-12-17", "2025-11-25", "2025-11-03", "2025-07-15"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Fern",
			BaseURL:    "https://www.buildwithfern.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4390327093/",
							Location:             "Addis Ababa, Addis Ababa, Ethiopia",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "WebBeds",
			BaseURL:    "https://www.webbeds.com/",
			CareersURL: "https://www.webbeds.com/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                13598746,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4410189183/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "BNP Paribas",
			BaseURL:    "https://group.bnpparibas/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.distribusion.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Thales",
			BaseURL:    "https://www.thalesgroup.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Technical Lead (Golang/C++ Developer)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4366757925/",
							Location:             "Noida, Uttar Pradesh, India",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-18", "2026-04-28", "2026-04-03", "2026-01-29"),
							WithSalary:           false,
							Remote:               false,
						},
						{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4406149759/",
							Location:             "Mumbai, Maharashtra, India",
							CloudProviders:       []domain.CloudProvider{domain.AWS, domain.GCP},
							Date:                 mustDate("2026-04-28"),
							WithSalary:           false,
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4416637903/",
							Location:             "Mumbai, Maharashtra, India",
							CloudProviders:       []domain.CloudProvider{domain.AWS, domain.GCP},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Motadata",
			BaseURL:    "https://www.motadata.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Full Stack Engineer – Golang/React.js",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344224603/",
							Location:             "Ahmedabad, Gujarat, India",
							Date:                 mustDate("2025-12-17"),
							WithSalary:           false,
							Remote:               false,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Bengaluru, Karnataka, India",
							Date:                 mustDate("2026-01-10", "2025-12-20", "2025-11-28", "2025-10-16"),
							WithSalary:           false,
							Remote:               false,
						},
						{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4415004583/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SolarWinds",
			BaseURL:    "https://www.solarwinds.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4403363549/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "NinjaOne",
			BaseURL:    "https://www.ninjaone.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4416654004/",
							Location:             "Ottawa, ON",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20"),
							WithSalary:           false,
