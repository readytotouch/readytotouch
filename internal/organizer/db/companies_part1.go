				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "AI/ML Staff",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4149777785/",
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4148756755/",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Go-To-Market",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4151497036/",
							Date:                 mustDate("2025-02-13"),
							WithSalary:           true, // $175.000 - $288.000 per year
							Remote:               false,
						},
					},
				},
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Juju Software Engineer (Go",
							ShortDescription:     "",
							SwitchingOpportunity: "",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2025-01-26"), // mustDate("2025-01-03"),
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "API Connect",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4148763110/",
							Date:                 mustDate("2025-02-12"),
							WithSalary:           false,
							Remote:               false,
						},
