			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "SAP iXP Intern — Software Developer with Java or Golang",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4072911263/",
							Date:                 mustDate("2025-01-06"),
							WithSalary:           false,
						},
					},
				},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2025-01-10"),
							WithSalary:           false, // Salary range is $81,000 - $110,000
							Remote:               false,
						},
					},
				},
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Middle level Back-end (Go) Engineer  — Content Platform team",
							ShortDescription:     "Backend: Go, ArangoDB, MySQL, Confluent Kafka, Snowflake, GraphQL + different AWS services",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4121215563/",
							Date:                 mustDate("2025-01-09"),
							WithSalary:           false,
							Remote:               false,
						},
