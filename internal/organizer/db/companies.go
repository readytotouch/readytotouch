...
func Companies() []domain.CompanyProfile {
	var (
		...
		shard24            = companies24Shard()
		shard25            = companies25Shard()
		shard26            = companies26Shard()
	...
	result = append(result, shard24...)
	result = append(result, shard25...)
	result = append(result, shard26...)
