	...
	return []domain.CompanyProfile{
		{
			...
			Type:       "", // system
			Name:       "NBCUniversal",
			BaseURL:    "https://www.nbcuniversal.com/",
			CareersURL: "https://www.nbcunicareers.com/",
			AboutURL:   "https://www.nbcuniversal.com/about",
			BlogURL:    "",
...

		{
			...
			Type:       "", // system
			Name:       "Sendle",
			BaseURL:    "https://www.sendle.com/",
			CareersURL: "https://try.sendle.com/careers",
			AboutURL:   "https://try.sendle.com/en-au/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                4846518,
				Alias:             "sendle",
...

		{
			...
			BaseURL:    "https://www.arfdlaw.com/",
			CareersURL: "",
			AboutURL:   "https://www.arfdlaw.com/our-firm/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2436230,
				Alias:             "arfdlaw",
...

		{
			...
			AboutURL:   "https://www.canva.com/about/",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-05-21", "2026-02-03", "2026-01-13"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							Title:                "Staff Software Engineer (Golang, Python, AWS)",
							ShortDescription:     "Data Sync Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4367377045/",
							Location:             "Perth, Western Australia, Australia",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
							Date:                 mustDate("2026-05-19", "2026-04-28", "2026-04-04"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							Title:                "Staff Software Engineer (Java/ Golang)",
							ShortDescription:     "Infra – Quality Platform",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4379744802/",
						...
						},
						{
							...
							ShortDescription:     "Cloud Compute Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4432490837/",
							Location:             "Sydney, New South Wales, Australia",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			Type:       "", // system
			Name:       "Adtran",
			BaseURL:    "https://www.adtran.com/",
			CareersURL: "https://www.adtran.com/en/about-us/careers",
			AboutURL:   "https://www.adtran.com/en/about-us",
			BlogURL:    "https://www.blog.adtran.com/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                8049,
				Alias:             "adtran",
				Name:              "Adtran",
...

		{
			...
			CareersURL: "https://www.photoroom.com/company#careers",
			AboutURL:   "https://www.photoroom.com/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                26243215,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4382394370/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387495006/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4412799086/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			CareersURL: "https://careers.etsy.com/global/en",
			AboutURL:   "https://www.etsy.com/about",
...

		{
			...
			Type:       "", // system
			Name:       "AppFlowy",
			BaseURL:    "https://appflowy.com/",
			CareersURL: "https://appflowy.com/join",
			AboutURL:   "https://appflowy.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                81474610,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Arm",
			BaseURL:    "https://www.arm.com/",
			CareersURL: "https://careers.arm.com/",
			AboutURL:   "https://www.arm.com/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                4472,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Embecosm",
			BaseURL:    "https://embecosm.com/",
			CareersURL: "",
			AboutURL:   "https://embecosm.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2933938,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Helsing",
			BaseURL:    "https://helsing.ai/",
			CareersURL: "https://helsing.ai/jobs",
			AboutURL:   "https://helsing.ai/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                71719093,
				IDs:               nil,
		...
		},
		{
			...
			AboutURL:   "https://www.jetbrains.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                12515,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344532660/",
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4360516244/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			Type:       "", // system
			Name:       "Garena",
			BaseURL:    "https://www.garena.sg/",
			CareersURL: "https://careers.garena.com/global/careers",
			AboutURL:   "https://careers.garena.com/global/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                13678254,
				IDs:               nil,
...

		{
			...
			CareersURL: "https://www.moneylion.com/careers/",
			AboutURL:   "https://www.moneylion.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3489789,
				IDs:               nil,
...

		{
			...
			BaseURL:    "https://www.loblaw.ca/",
			CareersURL: "https://careers.loblaw.ca/",
			AboutURL:   "https://www.loblaw.ca/en/who-we-are/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                164756,
...

		{
			...
			Type:       "", // system
			Name:       "Qonto",
			BaseURL:    "https://qonto.com/",
			CareersURL: "https://qonto.com/en/careers",
			AboutURL:   "https://qonto.com/en/about",
			BlogURL:    "https://medium.com/qonto-way",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                13205888,
				IDs:               nil,
				Alias:             "qonto",
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior/Staff – Go Backend Engineer",
							ShortDescription:     "",
							SwitchingOpportunity: "",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4295473279/",
						...
						{
							Title:                "Product Engineer (Fullstack – Go / React)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4369930539/",
							Location:             "Milan, Lombardy, Italy",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4372182744/",
							Location:             "Paris, Île-de-France, France",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-28", "2026-03-10"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							Title:                "Product Engineer (Go and/or React)",
							ShortDescription:     "Accounting Domain",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4369940161/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4401087076/",
							Location:             "Milan, Lombardy, Italy",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			Type:       "", // system
			Name:       "iCapital",
			BaseURL:    "https://icapital.com/",
			CareersURL: "https://icapital.com/careers/",
			AboutURL:   "https://icapital.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3080201,
				IDs:               nil,
			...
			Languages: domain.Languages{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-19", "2026-01-29"),
						...
						},
						{
							...
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-29", "2026-04-08", "2026-03-19"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						{
							Title:                "Full Stack Engineer (Elixir)",
							ShortDescription:     "The backend is built in Elixir/Phoenix, with some Go and Node.js, backed by PostgreSQL",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4385546734/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387278069/",
							Location:             "Lisbon, Lisbon, Portugal",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-21", "2026-04-28", "2026-04-09", "2026-03-19"),
							WithSalary:           false,
							Remote:               false,
						},
					},
...

		{
			...
			Type:       "", // system
			Name:       "Expedia Group",
			BaseURL:    "https://expediagroup.com/",
			CareersURL: "https://careers.expediagroup.com/",
			AboutURL:   "https://www.expediagroup.com/who-we-are/our-story/default.aspx",
...

		{
			...
			Type:       "", // system
			Name:       "Esri",
			BaseURL:    "https://www.esri.com/",
			CareersURL: "https://www.esri.com/en-us/about/careers/overview",
			AboutURL:   "https://www.esri.com/en-us/about/about-esri/overview",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5311,
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4417031521/",
							Location:             "Redlands, CA",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			Type:       "", // system
			Name:       "CloudLinux",
			BaseURL:    "https://www.cloudlinux.com/",
			CareersURL: "https://www.cloudlinux.com/about-us-company-jobs/",
			AboutURL:   "https://www.cloudlinux.com/about-us/",
			BlogURL:    "https://blog.cloudlinux.com/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                632769,
				IDs:               nil,
				Alias:             "cloudlinux",
...

		{
			...
			Type:       "", // system
			Name:       "Green Packet",
			BaseURL:    "https://www.greenpacket.com/",
			CareersURL: "https://www.greenpacket.com/careers",
			AboutURL:   "https://www.greenpacket.com/company/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                81702,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Bloomreach",
			BaseURL:    "https://www.bloomreach.com/",
			CareersURL: "https://www.bloomreach.com/en/careers",
			AboutURL:   "https://www.bloomreach.com/en/about-us",
			BlogURL:    "https://dev.to/bloomreach",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                36076,
				IDs:               nil,
				Alias:             "bloomreach",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4414230482/",
							Location:             "Slovakia",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			CareersURL: "https://www.fidelity.com/about-fidelity/careers",
			AboutURL:   "https://www.fidelity.com/about-fidelity/our-company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1307,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-04-17", "2026-03-28", "2026-03-06", "2026-02-13", "2026-01-22", "2025-12-10", "2025-12-02", "2025-11-23", "2025-11-02"),
...

		{
			...
			BaseURL:    "https://www.breadfinancial.com/",
			CareersURL: "https://www.breadfinancial.com/en/who-we-are/careers.html",
			AboutURL:   "https://www.breadfinancial.com/en/who-we-are.html",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                84108929,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Appear",
			BaseURL:    "https://www.appear.net/",
			CareersURL: "https://careers.appear.net/jobs",
			AboutURL:   "https://www.appear.net/company-overview/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                99029,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4389254236/",
...

		{
			...
			Type:       "", // system
			Name:       "Worldline",
			BaseURL:    "https://worldline.com/",
			CareersURL: "https://jobs.worldline.com/",
			AboutURL:   "https://worldline.com/en/home/top-navigation/about-worldline/who-we-are",
			BlogURL:    "https://blog.worldline.tech/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2611817,
...

		{
			...
			CareersURL: "https://careers.whatnot.com/",
			AboutURL:   "https://www.whatnot.com/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                52160608,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "DNSFilter",
			BaseURL:    "https://www.dnsfilter.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Forcepoint",
			BaseURL:    "https://www.forcepoint.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4346208542/",
							Location:             "Thane, Maharashtra, India",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4381637598/",
							Location:             "Thane, Maharashtra, India",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-19", "2026-03-10", "2026-03-06"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4410568017/",
							Location:             "Thane, Maharashtra, India",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Barracuda",
			BaseURL:    "https://www.barracuda.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387958739/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394495843/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
							Date:                 mustDate("2026-04-06"),
							WithSalary:           false,
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4402784049/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4405331178/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4406599697/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Teradata",
			BaseURL:    "https://www.teradata.com/",
			CareersURL: "https://www.teradata.com/about-us/careers",
			AboutURL:   "https://www.teradata.com/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1466,
				IDs:               []int{1466, 14996},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4345740779/",
							Location:             "Tallinn, Harjumaa, Estonia",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4352762712/",
							Location:             "Tallinn, Harjumaa, Estonia",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4354031247/",
							Location:             "Tallinn, Harjumaa, Estonia",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-01-20"),
							WithSalary:           false,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4408056717/",
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-29"),
							WithSalary:           false,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344055541/",
							Location:             "Delhi, Delhi, India",
							Date:                 mustDate("2025-12-17"),
							WithSalary:           false,
							Remote:               false,
					...
					Vacancies: []domain.Vacancy{
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-07", "2026-01-24"),
							WithSalary:           false,
							Remote:               false,
						},
						{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-27", "2026-02-06"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4356252758/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "commercetools",
			BaseURL:    "https://www.commercetools.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4370369870/",
							Location:             "Berlin, Germany",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-15", "2026-03-25", "2026-03-02"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Net Health",
			BaseURL:    "https://www.nethealth.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4371840115/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4421306225/",
							Location:             "Carlsbad, CA",
							CloudProviders:       []domain.CloudProvider{},
			...
			Languages: domain.Languages{
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Fullstack Engineer (Elixir)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4392174901/",
							Location:             "Cracow, Małopolskie, Poland",
							CloudProviders:       []domain.CloudProvider{},
...

		{
			...
			CareersURL: "https://jobs.virginia.edu/",
			AboutURL:   "https://www.virginia.edu/aboutuva/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                4298,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Phrase",
			BaseURL:    "https://phrase.com/",
			CareersURL: "https://phrase.com/careers/",
			AboutURL:   "https://phrase.com/about/",
			BlogURL:    "https://phrase.com/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1344091,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Mr Price Group",
			BaseURL:    "https://mrpricegroup.com/",
			CareersURL: "https://mrpcareers.com/our-careers/",
			AboutURL:   "https://mrpricegroup.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                47016,
...

		{
			...
			Type:       "", // system
			Name:       "PlentyONE",
			BaseURL:    "https://www.plentyone.com/",
			CareersURL: "https://www.plentyone.com/careers",
			AboutURL:   "https://www.plentyone.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5079248,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Future",
			BaseURL:    "https://www.future.co/",
			CareersURL: "https://www.future.co/careers",
			AboutURL:   "https://www.future.co/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                33275761,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4376239645/",
							Location:             "United States",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
							Date:                 mustDate("2026-03-01"),
							WithSalary:           false,
...

		{
			...
			BaseURL:    "https://www.lanl.gov/",
			CareersURL: "https://www.lanl.gov/careers",
			AboutURL:   "https://www.lanl.gov/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5327,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4328336721/",
							Location:             "Bangkok, Bangkok City, Thailand",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20", "2026-04-27", "2026-04-05"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4330224287/",
							Location:             "Hanoi, Hanoi, Vietnam",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "bet365",
			BaseURL:    "https://www.bet365careers.com/en",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.getnelly.de/",
			CareersURL: "https://www.getnelly.de/jobs",
			AboutURL:   "https://www.getnelly.de/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                74522753,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Berlin, Berlin, Germany",
							Date:                 mustDate("2026-01-09", "2025-12-17", "2025-11-25"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383099059/",
							Location:             "Berlin, Germany",
							CloudProviders:       []domain.CloudProvider{},
