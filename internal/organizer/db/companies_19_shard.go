	...
	return []domain.CompanyProfile{
		{
			...
			BaseURL:    "https://www.valencesecurity.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2026-03-04", "2026-02-10", "2026-01-20", "2025-12-08", "2025-11-17", "2025-10-27", "2025-10-06", "2025-09-14", "2025-08-23", "2025-08-02", "2025-07-10", "2025-06-23"),
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4410948326/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4412852577/",
							Location:             "Santa Clara, CA",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20"),
							WithSalary:           true, // ca$125k/yr - ca$200k/yr
							Remote:               false,
						},
					},
				},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "blockit",
			BaseURL:    "https://www.blockitnow.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			CareersURL: "https://www.experian.com/careers/",
			AboutURL:   "https://www.experian.com/corporate/about-experian",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2534,
			...
			Languages: domain.Languages{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Staff Software Engineer – Java, Scala, AWS",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4408796782/",
							Location:             "Hyderabad, Telangana, India",
		...
		},
		{
			...
			BaseURL:    "https://www.thomsonreuters.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Stori",
			BaseURL:    "https://www.storicard.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Wolters Kluwer",
			BaseURL:    "https://www.wolterskluwer.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394704475/",
							Location:             "Porto, Porto, Portugal",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20", "2026-04-06"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394717321/",
							Location:             "Porto, Porto, Portugal",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			BaseURL:    "https://www.parallelwireless.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "MarkeTeam.ai",
			BaseURL:    "https://www.marketeam.ai/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "Transition from Go, Rust, and Ruby to Elixir",
							URL:                  "https://www.linkedin.com/jobs/view/4346209101/",
							Location:             "Tel Aviv-Yafo, Tel Aviv District, Israel",
							Date:                 mustDate("2025-12-26"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			BaseURL:    "https://www.whitehatgaming.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.whitefoxdefense.com/",
			CareersURL: "https://www.whitefoxdefense.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                17943090,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20", "2026-05-13", "2026-04-14", "2026-03-31"),
							WithSalary:           false,
							Remote:               true,
						},
					},
		...
		},
		{
			...
			BaseURL:    "https://www.milestonesys.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Software Engineer – Golang",
							ShortDescription:     "Email Security Platform",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4353927512/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SmartBear",
			BaseURL:    "https://smartbear.com/",
			CareersURL: "https://smartbear.com/company/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                108422,
		...
		},
		{
			...
			BaseURL:    "https://hellohealthgroup.com/",
			CareersURL: "https://hellohealthgroup.com/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                6448869,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "RIIICO",
			BaseURL:    "https://riiico.com/",
			CareersURL: "",
			AboutURL:   "https://riiico.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                69330782,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Boozt",
			BaseURL:    "https://www.boozt.com/",
			CareersURL: "https://careers.booztgroup.com/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                478478,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "FrankieOne",
			BaseURL:    "https://frankieone.com/",
			CareersURL: "https://careers.frankieone.com/",
			AboutURL:   "https://frankieone.com/frankieone-about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                35577295,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "OXIO",
			BaseURL:    "https://oxio.com/",
			CareersURL: "https://oxio.com/join-the-team/",
			AboutURL:   "https://oxio.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                28141767,
				IDs:               nil,
				...
				domain.Haskell: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Collingwood, Victoria, Australia",
							Date:                 mustDate("2026-01-10", "2025-12-20"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Azion",
			BaseURL:    "https://www.azion.com/",
			CareersURL: "https://www.azion.com/en/careers/",
			AboutURL:   "https://www.azion.com/en/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2137446,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4394462726/",
		...
		},
		{
			...
			BaseURL:    "https://www.riversideresearch.org/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Winnow",
			BaseURL:    "https://www.winnowsolutions.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Principal Platform Engineer Golang",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4364484097/",
							Location:             "United States",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
		...
		},
		{
			...
			AboutURL:   "https://www.adyen.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                279565,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Immutable",
			BaseURL:    "https://www.immutable.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Octopus Money",
			BaseURL:    "https://octopusmoney.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
							Date:                 mustDate("2026-01-15", "2025-12-20"),
							WithSalary:           false,
							Remote:               false,
						},
						{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Julius Baer",
			BaseURL:    "https://www.juliusbaer.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Papa",
			BaseURL:    "https://www.papa.com/",
			CareersURL: "https://www.papa.com/careers",
			AboutURL:   "https://www.papa.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                10879786,
				IDs:               nil,
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "United States",
							Date:                 mustDate("2025-12-19", "2025-11-29", "2025-11-08", "2025-10-17"),
							WithSalary:           false,
							Remote:               true,
						},
						{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383297585/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4393802164/",
							Location:             "United States",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
		...
		},
		{
			...
			CareersURL: "https://bitwarden.com/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                24776937,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Virtuozzo",
			BaseURL:    "https://www.virtuozzo.com/",
			CareersURL: "",
			AboutURL:   "https://www.virtuozzo.com/company/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                10358578,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Santa Clara, CA",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-21", "2026-04-29", "2026-04-08"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4399102553/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4414192793/",
							Location:             "Redmond, WA",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			AboutURL:   "https://www.klarna.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                748731,
				IDs:               nil,
			...
			Languages: domain.Languages{
				...
				domain.Erlang: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Erlang Engineer",
							ShortDescription:     "Dunning Banking Servicing",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387857097/",
							Location:             "Stockholm, Stockholm County, Sweden",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-06-21", "2026-05-08", "2026-03-25", "2025-12-09", "2025-11-17", "2025-10-27", "2025-10-05", "2025-09-13", "2025-08-22"),
