...
func companies20Shard() []domain.CompanyProfile {
	return []domain.CompanyProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4400184399/",
							Location:             "Limassol, Cyprus",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-04-17"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Deloitte",
			BaseURL:    "https://www.deloitte.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Toronto, ON",
							Date:                 mustDate("2026-01-25", "2025-12-13", "2025-11-20"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4374518165/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4379909137/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4411520563/",
						...
						{
							Title:                "Full Stack Developer (Java / Python / Go)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4413069199/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Revvity",
			BaseURL:    "https://www.revvity.com/",
			CareersURL: "https://jobs.revvity.com/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                90499149,
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-05-04", "2026-04-13", "2026-03-22", "2026-02-28", "2026-02-08"),
							WithSalary:           true, // $118.5k/yr - $142k/yr
							Remote:               false,
						},
						{
							Title:                "Principal Software Development Engineer (Scala)",
							ShortDescription:     "Big Data Engineering",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4371719838/",
							Location:             "Boston, MA",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Batuta",
			BaseURL:    "https://batuta.com/",
			CareersURL: "",
			AboutURL:   "https://batuta.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                18752548,
				IDs:               nil,
		...
		},
		{
			...
			BaseURL:    "https://www.nozominetworks.com/",
			CareersURL: "https://www.nozominetworks.com/company/careers",
			AboutURL:   "https://www.nozominetworks.com/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5093151,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Simplisales",
			BaseURL:    "https://simplisales.com/",
			CareersURL: "",
			AboutURL:   "https://simplisales.com/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                84357358,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "BioCatch",
			BaseURL:    "https://www.biocatch.com/",
			CareersURL: "https://www.biocatch.com/company",
			AboutURL:   "https://www.biocatch.com/cybersecurity-careers",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2689103,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Infact",
			BaseURL:    "https://infact.io/",
			CareersURL: "https://infact.io/about",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                86375533,
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Product Engineer – Go",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4429709238/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Planet",
			BaseURL:    "https://www.weareplanet.com/",
			CareersURL: "https://www.weareplanet.com/careers",
			AboutURL:   "https://www.weareplanet.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                114374,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Swapcard",
			BaseURL:    "https://www.swapcard.com/",
			CareersURL: "https://www.swapcard.com/careers",
			AboutURL:   "https://www.swapcard.com/about-swapcard",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3177729,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SandboxAQ",
			BaseURL:    "https://www.sandboxaq.com/",
			CareersURL: "https://www.sandboxaq.com/careers",
			AboutURL:   "https://www.sandboxaq.com/company/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                79089195,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Roslin",
			BaseURL:    "https://www.roslin.us/",
			CareersURL: "https://www.roslin.us/careers",
			AboutURL:   "https://www.roslin.us/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                79301238,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "EasyPost",
			BaseURL:    "https://www.easypost.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4406755362/",
							Location:             "Ottawa, ON",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4362074281/",
							Location:             "Santiago, Santiago Metropolitan Region, Chile",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-05-15", "2026-04-23", "2026-04-02", "2026-02-19", "2026-01-08", "2025-12-17", "2025-11-26"),
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Tietoevry",
			BaseURL:    "https://www.tietoevry.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2025-12-14", "2025-11-22"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4343903948/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Leaseweb",
			BaseURL:    "https://www.leaseweb.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Developer Platform Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383014208/",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "FluidCloud",
			BaseURL:    "https://www.fluidcloud.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "iFood",
			BaseURL:    "https://www.ifood.com.br/",
			CareersURL: "https://carreiras.ifood.com.br/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                247645,
				IDs:               []int{247645, 101015933},
				Alias:             "ifood-",
				Name:              "iFood",
				Followers:         "2M",
				Employees:         "5K-10K",
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Staff Backend Software Engineer (Golang)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4342066018/",
							Location:             "Brazil",
		...
		},
		{
			...
			BaseURL:    "https://www.amplifiloyalty.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Bigabid",
			BaseURL:    "https://www.bigabid.com/",
			CareersURL: "https://www.bigabid.com/careers/",
			AboutURL:   "https://www.bigabid.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                10033874,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Permutive",
			BaseURL:    "https://permutive.com/",
			CareersURL: "https://permutive.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9314455,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Innovatrics",
			BaseURL:    "https://www.innovatrics.com/",
			CareersURL: "https://careers.innovatrics.com/",
			AboutURL:   "https://www.innovatrics.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1016818,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Spire",
			BaseURL:    "https://spire.com/",
			CareersURL: "https://spire.com/careers/job-openings/",
			AboutURL:   "https://spire.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3506863,
				IDs:               nil,
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-01-16", "2025-12-25", "2025-10-01", "2025-09-09"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							Date:                 mustDate("2026-06-20", "2026-05-06", "2026-04-14", "2026-03-23", "2026-02-28", "2025-12-05"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-11", "2026-04-19", "2026-03-07"),
							WithSalary:           false,
							Remote:               false,
						},
						{
		...
		},
		{
			...
			BaseURL:    "https://lgads.tv/",
			CareersURL: "https://lgads.tv/careers/",
			AboutURL:   "https://lgads.tv/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3100031,
				IDs:               nil,
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Backend Software Engineer (C++, Golang)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4365112789/",
							Location:             "Denver, CO",
							CloudProviders:       []domain.CloudProvider{},
						...
						{
							Title:                "Backend Software Engineer (C++, Go)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4429595125/",
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
							Date:                 mustDate("2026-06-20"),
							WithSalary:           false,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Brevo",
			BaseURL:    "https://www.brevo.com/",
			CareersURL: "https://www.brevo.com/careers/",
			AboutURL:   "https://www.brevo.com/company/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2346309,
				IDs:               nil,
		...
		},
		{
			...
			CareersURL: "https://www.hudl.com/jobs",
			AboutURL:   "https://www.hudl.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2464624,
				IDs:               nil,
				...
				domain.Clojure: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4353544085/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-01-16"),
							WithSalary:           true, // £66k/yr - £111k/yr
							Remote:               false,
						},
					},
				},
		...
		},
		{
			...
			BaseURL:    "https://www.recordedfuture.com/",
			CareersURL: "https://www.recordedfuture.com/work-with-us/jobs",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                678036,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Opensignal",
			BaseURL:    "https://www.opensignal.com/",
			CareersURL: "https://www.opensignal.com/about/opensignal-careers",
			AboutURL:   "https://www.opensignal.com/about-us",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1954386,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Football Radar",
			BaseURL:    "https://www.footballradar.com/",
			CareersURL: "https://www.footballradar.com/careers/",
			AboutURL:   "https://www.footballradar.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1697361,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Yoti",
			BaseURL:    "https://www.yoti.com/",
			CareersURL: "https://www.yoti.com/jobs/",
			AboutURL:   "https://www.yoti.com/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9428931,
				IDs:               nil,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377295239/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383955767/",
							Location:             "London, England, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SoLo Funds",
			BaseURL:    "https://solofunds.com/",
			CareersURL: "https://solofunds.com/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9424483,
		...
		},
		{
			...
			BaseURL:    "https://airspacelink.com/",
			CareersURL: "https://airspacelink.com/careers",
			AboutURL:   "https://airspacelink.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                28592338,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Lumel",
			BaseURL:    "https://lumel.com/",
			CareersURL: "https://lumel.com/careers/",
			AboutURL:   "https://lumel.com/about-us/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                75039399,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "RoboMarkets",
			BaseURL:    "https://www.robomarkets.com.cy/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4379958176/",
							Location:             "Thu Đuc, Vietnam",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-02"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4400923755/",
							Location:             "Thu Đuc, Vietnam",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Cruit",
			BaseURL:    "https://www.joincruit.com/",
			CareersURL: "",
			AboutURL:   "https://www.joincruit.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                81771726,
				IDs:               nil,
		...
		},
		{
			...
			BaseURL:    "https://blackpointcyber.com/",
			CareersURL: "https://blackpointcyber.com/company/careers/",
			AboutURL:   "https://blackpointcyber.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9381059,
				IDs:               nil,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "RapidAI",
			BaseURL:    "https://www.rapidai.com/",
			CareersURL: "https://www.rapidai.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                37506734,
		...
		},
		{
			...
			Type:       "", // system
			Name:       "OpenText",
			BaseURL:    "https://www.opentext.com/",
			CareersURL: "https://careers.opentext.com/",
			AboutURL:   "https://www.opentext.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2709,
