...
func companies04Shard() []domain.CompanyProfile {
	return []domain.CompanyProfile{
			...
			Languages: domain.Languages{
				...
				domain.Haskell: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Backend Engineer – Product",
							ShortDescription:     "",
							SwitchingOpportunity: "Knowledge of or excitement to learn Haskell, and proficiency in SQL",
							URL:                  "https://www.linkedin.com/jobs/view/4210758136/",
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2026-06-21", "2026-05-10", "2026-04-17", "2026-03-28", "2026-03-07", "2026-02-13", "2026-01-23", "2025-12-10", "2025-11-19", "2025-10-29", "2025-10-08", "2025-09-16"),
			...
			Languages: domain.Languages{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Software Engineer – Rust & AWS APIs",
							ShortDescription:     "",
							SwitchingOpportunity: "",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2026-02-14", "2025-12-13", "2025-11-01", "2025-10-11", "2025-07-16", "2025-06-05", "2025-05-15", "2025-04-02"),
							WithSalary:           false,
							Remote:               false,
						},
						{
						...
						},
						{
							...
							Location:             "Tel Aviv-Yafo, Tel Aviv District, Israel",
							Date:                 mustDate("2026-01-25", "2025-12-14", "2025-11-01"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4364909674/",
							Location:             "Boulder, CO",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1292,
				IDs:               []int{1291, 1292, 1294, 1295, 1296, 1301, 1303, 1304, 1305, 2080, 3595, 3598, 3815, 3907, 3908, 3910, 6696, 7827, 7829, 7956, 15817, 51941, 166865, 255569, 418687, 444310, 513007, 1075902, 1080391, 1097772, 1500141, 2486040, 2525658, 2569065, 2576937, 2739821, 2777915, 3146632, 10288516, 11826960, 18380517, 35634467, 68995044, 73443968, 74544528, 82749060, 103560838, 110597290},
				Alias:             "the-walt-disney-company",
				Name:              "The Walt Disney Company",
				Followers:         "6M",
				Employees:         "10K+",
				AssociatedMembers: "186,055",
				Verified:          true,
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-23", "2026-02-01", "2026-01-11"),
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383589451/",
							Location:             "New York, NY",
							CloudProviders:       []domain.CloudProvider{},
			...
			Languages: domain.Languages{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Software Engineer – Rust",
							ShortDescription:     "Feature Flags",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4372143030/",
						...
						},
						{
							...
							ShortDescription:     "Feature Flags",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4372140418/",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4328926389/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4370389853/",
							Location:             "Berlin, Germany",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-02-25", "2026-02-10"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4401041424/",
							Location:             "Berlin, Germany",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4377886039/",
							Location:             "West Jerusalem, Jerusalem District, Israel",
							CloudProviders:       []domain.CloudProvider{domain.AWS},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4354043594/",
							Location:             "Poland",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4373159039/",
							Location:             "Poland",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4387514260/",
							Location:             "Poland",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4429712097/",
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4380456524/",
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4385935888/",
							Location:             "Stockholm, Stockholm County, Sweden",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4390162368/",
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "India",
							Date:                 mustDate("2026-05-11", "2026-04-10", "2026-03-12", "2026-02-05", "2025-11-29", "2025-11-12", "2025-10-16"),
							WithSalary:           false,
							Remote:               true,
						},
					},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4356593825/",
							Location:             "Bellevue, WA",
							CloudProviders:       []domain.CloudProvider{domain.Azure},
							Date:                 mustDate("2026-02-12", "2026-01-30"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "Search & Database Engines",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4384080611/",
							Location:             "Bellevue, WA",
							CloudProviders:       []domain.CloudProvider{domain.Azure},
							Date:                 mustDate("2026-03-17"),
							WithSalary:           false,
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4401662214/",
							Location:             "Seattle, WA",
							CloudProviders:       []domain.CloudProvider{domain.Azure},
							Date:                 mustDate("2026-06-25", "2026-04-21"),
							WithSalary:           false,
							Remote:               false,
						},
						{
