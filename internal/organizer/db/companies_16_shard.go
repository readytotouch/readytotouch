				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4413486883/",
							Location:             "Türkiye",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4407459935/",
							Location:             "Ho Chi Minh City, Ho Chi Minh City, Vietnam",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4421140728/",
							Location:             "Argentina",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Tanzania",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-14", "2026-05-10"),
							WithSalary:           false,
							Remote:               true,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4417341498/",
							Location:             "Estonia",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "New York, NY",
							Date:                 mustDate("2026-05-14", "2026-03-31", "2026-03-09", "2026-02-16", "2026-01-25", "2025-12-14", "2025-11-22", "2025-11-01", "2025-10-11", "2025-09-20", "2025-08-06"),
							WithSalary:           false,
							Remote:               false,
						},
						{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4414704613/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4416706306/",
							Location:             "London Area, United Kingdom",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4414505020/",
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4412870627/",
							Location:             "Philippines",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-20"),
							WithSalary:           true, // $30k/yr - $45k/yr
