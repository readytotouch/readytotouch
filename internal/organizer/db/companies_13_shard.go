...
func companies13Shard() []domain.CompanyProfile {
	return []domain.CompanyProfile{
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Netscribes",
			BaseURL:    "https://www.netscribes.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://wbd.com/",
			CareersURL: "https://careers.wbd.com/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                73234923,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "MSC Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344443745/",
							Location:             "Bengaluru, Karnataka, India",
							Date:                 mustDate("2026-01-09", "2025-12-17"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							Title:                "Senior Software Engineer – Backend (Golang/Java)",
							ShortDescription:     "Consumer Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4378740863/",
							Location:             "Greater Hyderabad Area",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-20", "2026-02-28"),
							WithSalary:           false,
							Remote:               false,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "VOIS",
			BaseURL:    "https://www.vodafone.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://www.walmartdataventures.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4314788143/",
							Location:             "Singapore, Singapore",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-18", "2026-04-28", "2026-04-04", "2026-02-22", "2026-01-30"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							Title:                "Staff Engineer, Rust Blockchain",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4289462756/",
							Location:             "Singapore, Singapore",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-24", "2026-03-01", "2026-02-08"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4376085242/",
							Location:             "Singapore, Singapore",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-22", "2026-04-30", "2026-04-09", "2026-03-19", "2026-02-25"),
							WithSalary:           false,
							Remote:               false,
						},
					},
			...
			ShortDescription: "Crypto trading app",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "SurrealDB",
			BaseURL:    "https://surrealdb.com/",
			CareersURL: "https://surrealdb.com/careers",
			AboutURL:   "https://medium.com/surrealdb/about",
			BlogURL:    "https://surrealdb.com/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                71534355,
				IDs:               nil,
				Alias:             "surrealdb",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "Clockwork Labs",
			BaseURL:    "https://clockworklabs.io/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
		...
		},
		{
			...
			BaseURL:    "https://pola.rs/",
			CareersURL: "",
			AboutURL:   "https://pola.rs/about-us/",
			BlogURL:    "https://pola.rs/posts/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                98439348,
				IDs:               nil,
				Alias:             "pola-rs",
...

		{
			...
			BaseURL:    "https://tsunamitsolutions.com/",
			CareersURL: "https://tsunamitsolutions.com/index.php/careers/",
			AboutURL:   "https://tsunamitsolutions.com/index.php/who-we-are/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                983003,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Draper",
			BaseURL:    "https://www.draper.com/",
			CareersURL: "https://www.draper.com/careers",
			AboutURL:   "https://www.draper.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                163500,
				IDs:               nil,
...

		{
			...
			AboutURL:   "https://www.mayoclinic.org/about-mayo-clinic",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                4725,
				IDs:               nil,
...

		{
			...
			BaseURL:    "https://ufl.edu/",
			CareersURL: "https://jobs.ufl.edu/",
			AboutURL:   "https://www.ufl.edu/about/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                4282,
...

		{
			...
			BaseURL:    "https://www.sroa.com/",
			CareersURL: "https://www.sroa.com/careers",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                33228180,
...

		{
			...
			AboutURL:   "https://www.redhat.com/en/about",
			BlogURL:    "https://www.redhat.com/en/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3545,
				IDs:               []int{3545, 2993942, 4855292},
				Alias:             "red-hat",
				Name:              "Red Hat",
				Followers:         "2M",
				Employees:         "10K+",
				AssociatedMembers: "19,323",
				Verified:          true,
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Software Engineer — Backend (Golang/Node.js)",
							ShortDescription:     "REST API",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4416320634/",
					...
					Vacancies: []domain.Vacancy{
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4403796776/",
							Location:             "Raleigh, NC",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-17", "2026-04-28"),
							WithSalary:           false,
							Remote:               false,
						},
					},
...

		{
			...
			Type:       "", // system
			Name:       "OCC",
			BaseURL:    "https://www.theocc.com/",
			CareersURL: "https://www.theocc.com/careers",
			AboutURL:   "https://www.theocc.com/company-information/what-is-occ",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                47420,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Motive",
			BaseURL:    "https://gomotive.com/",
			CareersURL: "https://gomotive.com/company/careers/",
			AboutURL:   "",
			BlogURL:    "https://medium.com/motive-eng",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3271606,
				IDs:               nil,
				Alias:             "motive-inc",
...

		{
			...
			Type:       "", // system
			Name:       "Freddie Mac",
			BaseURL:    "https://www.freddiemac.com/",
			CareersURL: "https://careers.freddiemac.com/",
			AboutURL:   "https://www.freddiemac.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3140,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Stoke Space",
			BaseURL:    "https://www.stokespace.com/",
			CareersURL: "https://www.stokespace.com/careers/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                53254054,
			...
			Languages: domain.Languages{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Full-Stack Software Developer (Svelte + Rust)",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4340996335/",
							Location:             "Kent, WA",
...

		{
			...
			BaseURL:    "https://greynoise.io/",
			CareersURL: "https://www.greynoise.io/careers",
			AboutURL:   "https://www.greynoise.io/about",
			BlogURL:    "https://www.greynoise.io/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                11204989,
				IDs:               nil,
				Alias:             "greynoise",
...

		{
			...
			BaseURL:    "https://www.universalmusic.com/",
			CareersURL: "https://www.umusiccareers.com/",
			AboutURL:   "https://www.universalmusic.com/company/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                3007,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Circles",
			BaseURL:    "https://circles.co/",
			CareersURL: "https://circles.co/careers",
			AboutURL:   "https://circles.co/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                6449768,
				IDs:               []int{6449768, 96118751},
				Alias:             "circles1",
				Name:              "Circles",
				Followers:         "130K",
				Employees:         "501-1K",
				AssociatedMembers: "1,815",
				Verified:          true,
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4392163983/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4415904442/",
							Location:             "Bengaluru, Karnataka, India",
							CloudProviders:       []domain.CloudProvider{},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "PulsePoint",
			BaseURL:    "https://www.pulsepoint.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Location:             "Bellevue, WA",
							Date:                 mustDate("2026-01-16", "2025-12-25", "2025-11-12", "2025-10-22", "2025-10-01"),
							WithSalary:           true, // $144k/yr - $180k/yr
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4344254384/",
							Location:             "Thiruvananthapuram, Kerala, India",
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4380176759/",
							Location:             "Ho Chi Minh City, Vietnam",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-26", "2026-04-20", "2026-04-14", "2026-04-06", "2026-03-24", "2026-03-04"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "Strong proficiency in Go",
							SwitchingOpportunity: "",
							URL:                  "https://app.welcometothejungle.com/jobs/BjnIl5UA",
			...
			Languages: domain.Languages{
				domain.Go: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Senior Go Backend Developer",
							ShortDescription:     "Core Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4355313628/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						{
							Title:                "Senior Go Backend Developer",
							ShortDescription:     "User Experience Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4363073046/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "Core Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4373756979/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "Publisher Experience Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4379847302/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "User Experience Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4383009928/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "Core Team",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4389171991/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4402852943/",
							Location:             "Hamburg, Hamburg, Germany",
							CloudProviders:       []domain.CloudProvider{},
				...
				domain.Elixir: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-14", "2026-04-28"),
							WithSalary:           false,
							Remote:               true,
						},
					},
		...
		},
		{
			...
			Type:       "", // system
			Name:       "ActiveProspect",
			BaseURL:    "https://activeprospect.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				...
				domain.Scala: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4349455916/",
...

		{
			...
			Type:       "", // system
			Name:       "TileDB",
			BaseURL:    "https://tiledb.com/",
			CareersURL: "https://ats.rippling.com/tiledb-careers/jobs",
			AboutURL:   "https://tiledb.com/about/",
			BlogURL:    "https://tiledb.com/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                11301003,
				IDs:               nil,
				Alias:             "tiledb-inc",
...

		{
			...
			Type:       "", // system
			Name:       "Redpanda Data",
			BaseURL:    "https://redpanda.com/",
			CareersURL: "https://www.redpanda.com/careers",
			AboutURL:   "https://www.redpanda.com/about-us",
			BlogURL:    "https://www.redpanda.com/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                35528665,
				IDs:               nil,
				Alias:             "redpanda-data",
...

		{
			...
			CareersURL: "https://quizlet.com/careers",
			AboutURL:   "https://quizlet.com/mission",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                807920,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Svix",
			BaseURL:    "https://www.svix.com/",
			CareersURL: "https://www.svix.com/careers/",
			AboutURL:   "https://www.svix.com/about/",
			BlogURL:    "https://www.svix.com/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                71559487,
				IDs:               nil,
				Alias:             "svix",
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4414539150/",
...

		{
			...
			BaseURL:    "https://www.anduril.com/",
			CareersURL: "https://www.anduril.com/careers/",
			AboutURL:   "https://www.anduril.com/mission/",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                18293159,
				IDs:               nil,
				Alias:             "anduril",
				PreviousAliases:   []string{"andurilindustries"},
				Name:              "Anduril Industries",
				Followers:         "503K",
				Employees:         "1K-5K",
				AssociatedMembers: "7,237",
				Verified:          true,
				Date:              mustDate("2026-03-21"),
			},
			GitHubProfile: domain.GitHubProfile{
			...
			Languages: domain.Languages{
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Software Engineer",
							ShortDescription:     "2+ years of experience building tools and platforms using Go and other cloud-native technologies",
							SwitchingOpportunity: "",
							URL:                  "https://app.welcometothejungle.com/jobs/y1qZXQo1",
							Date:                 mustDate("2026-01-27"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4388134039/",
							Location:             "Fort Collins, CO",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-05-01", "2026-04-10", "2026-03-20"),
							WithSalary:           false,
							Remote:               false,
						},
						{
							...
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4411262290/",
							Location:             "Broomfield, CO",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-06-20", "2026-05-07"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Haskell: {
					...
					Vacancies: []domain.Vacancy{
						...
						{
							Title:                "Embedded Haskell Engineer",
							ShortDescription:     "",
							SwitchingOpportunity: "",
							URL:                  "https://www.linkedin.com/jobs/view/4369463265/",
							Location:             "Costa Mesa, CA",
							CloudProviders:       []domain.CloudProvider{},
							Date:                 mustDate("2026-03-20", "2026-02-26", "2026-02-06"),
...

		{
			...
			Type:       "", // system
			Name:       "CORYS",
			BaseURL:    "https://www.corys.com/",
			CareersURL: "https://www.corys.com/en/home/career/",
			AboutURL:   "https://www.corys.com/en/home/about-us/",
			BlogURL:    "https://www.corys.com/en/category/blog-en/engineering-blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                48613,
				IDs:               nil,
				Alias:             "corys",
		...
		},
		{
			...
			Type:       "", // system
			Name:       "360Dialog",
			BaseURL:    "https://www.360dialog.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
...

		{
			...
			Type:       "", // system
			Name:       "Actyx",
			BaseURL:    "https://www.actyx.com/",
			CareersURL: "https://actyx.notion.site/Jobs-Actyx-2e33f9042fcc45bdaa0b369a1af4897d",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                10114352,
...

		{
			...
			Type:       "", // system
			Name:       "Algorithmia",
			BaseURL:    "https://www.datarobot.com/",
			CareersURL: "https://www.datarobot.com/careers/open-positions/",
			AboutURL:   "https://www.datarobot.com/about-us/",
			BlogURL:    "https://www.datarobot.com/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                89599097,
				IDs:               nil,
				Alias:             "algorithmiaio",
...

		{
			...
			Type:       "", // system
			Name:       "Amedia",
			BaseURL:    "https://www.amedia.no/",
			CareersURL: "https://www.amedia.no/alle-stillinger",
			AboutURL:   "https://www.amedia.no/english",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2718150,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "ANIXE",
			BaseURL:    "https://www.anixe.pl/",
			CareersURL: "https://www.anixe.pl/jobs/",
			AboutURL:   "",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                126161,
...

		{
			...
			Type:       "", // system
			Name:       "AppSignal",
			BaseURL:    "https://www.appsignal.com/",
			CareersURL: "https://www.appsignal.com/jobs",
			AboutURL:   "https://www.appsignal.com/about",
			BlogURL:    "https://blog.appsignal.com/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2898136,
				IDs:               nil,
				Alias:             "appsignal",
...

		{
			...
			AboutURL:   "https://www.atlassian.com/company",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                22688,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Bitfury",
			BaseURL:    "https://bitfury.com/",
			CareersURL: "",
			AboutURL:   "https://bitfury.com/about",
			BlogURL:    "",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                5178019,
				IDs:               nil,
...

		{
			...
			AboutURL:   "https://about.pypl.com/about-us/",
			BlogURL:    "https://braintree.github.io/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1310825,
				IDs:               nil,
				Alias:             "braintree",
...

		{
			...
			Type:       "", // system
			Name:       "Brave",
			BaseURL:    "https://brave.com/",
			CareersURL: "https://brave.com/careers/",
			AboutURL:   "https://brave.com/about/",
			BlogURL:    "https://brave.com/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                7929354,
				IDs:               nil,
...

		{
			...
			Type:       "", // system
			Name:       "Ceph",
			BaseURL:    "https://ceph.io/",
			CareersURL: "https://ceph.io/en/community/jobs/",
			AboutURL:   "https://ceph.io/en/foundation/about/",
			BlogURL:    "https://ceph.io/en/news/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                2455652,
				IDs:               nil,
				Alias:             "ceph",
...

		{
			...
			Type:       "", // system
			Name:       "Progress Chef",
			BaseURL:    "https://www.chef.io/",
			CareersURL: "https://www.chef.io/careers",
			AboutURL:   "https://www.progress.com/company",
			BlogURL:    "https://www.chef.io/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                223176,
				IDs:               nil,
				Alias:             "chef-software",
...

		{
			...
			Type:       "", // system
			Name:       "Clever Cloud",
			BaseURL:    "https://www.clever-cloud.com/",
			CareersURL: "",
			AboutURL:   "https://www.clever-cloud.com/about/",
			BlogURL:    "https://www.clever-cloud.com/blog/?cat=engineering#grid",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1202148,
				IDs:               nil,
				Alias:             "clever-cloud",
...

		{
			...
			Type:       "", // system
			Name:       "Craft AI",
			BaseURL:    "https://www.craft.ai/",
			CareersURL: "https://craft-ai.welcomekit.co/",
			AboutURL:   "https://www.craft.ai/en/qui-sommes-nous",
			BlogURL:    "https://www.craft.ai/en/blog",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                9460012,
				IDs:               nil,
				Alias:             "craft-ai",
...

		{
			...
			Type:       "", // system
			Name:       "Cryptape",
			BaseURL:    "https://cryptape.com/",
			CareersURL: "",
			AboutURL:   "",
			BlogURL:    "https://blog.cryptape.com/series/engineering",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                18153446,
				IDs:               nil,
				Alias:             "realcryptape",
...

		{
			...
			CareersURL: "https://deepgram.com/careers",
			AboutURL:   "https://deepgram.com/about",
			BlogURL:    "https://deepgram.com/learn/article",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                7602597,
				IDs:               nil,
				Alias:             "deepgram",
...

		{
			...
			Type:       "", // system
			Name:       "Imperva",
			BaseURL:    "https://www.imperva.com/",
			CareersURL: "https://www.imperva.com/company/careers/",
			AboutURL:   "https://www.imperva.com/company/about/",
			BlogURL:    "https://www.imperva.com/blog/?category=engineering",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                14312,
				IDs:               nil,
				Alias:             "imperva",
...

		{
			...
			BaseURL:    "https://www.espressif.com/",
			CareersURL: "https://www.espressif.com/en/careers",
			AboutURL:   "https://www.espressif.com/en/company/about-espressif",
			BlogURL:    "https://developer.espressif.com/blog/",
			LinkedInProfile: domain.LinkedInProfile{
				ID:                1211602,
				IDs:               nil,
