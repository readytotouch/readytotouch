					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2025-08-20"), //  mustDate("2025-07-28"),
							WithSalary:           false,
							Remote:               false,
						},
					},
				...
				domain.Rust: {
					...
					Vacancies: []domain.Vacancy{
						...
						},
						{
							...
							Date:                 mustDate("2025-08-17", "2025-07-26"),
					...
					Vacancies: []domain.Vacancy{
						{
							...
							Date:                 mustDate("2025-08-11", "2025-07-20", "2025-06-28", "2025-06-08", "2025-05-17", "2025-04-24"),
